...
;; g23: booleans should cover 99% of cases. Other types should be considered only if necessary
;; g23: it might be beneficial to specify parameters as RECURSIVE or NON-RECURSIVE
(define boolean
